...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | `DA01AzuraVoice` | NPC_ | `0x00028AE9` | FemaleUniqueAzura | DA01 | _(no EDID)_ | `0x000A2C24` | `0x000A2C3F` | 1 | 0 | 1 | MEDIUM |
| 2 | `Nelacar` | NPC_ | `0x0001E7D5` | MaleElfHaughty | DA01 | _(no EDID)_ | `0x000A2C23` | `0x000A2C45` | 1 | 0 | 1 | LOW |
| 3 | `EncDragonPriest` | NPC_ | `0x00023A93` | CrDragonPriestVoice | MG07 | _(no EDID)_ | `0x000800FA` | `0x00080102` | 1 | 0 | 1 | HIGH |
| 4 | `EncDragonPriest` | NPC_ | `0x00023A93` | CrDragonPriestVoice | MG07 | _(no EDID)_ | `0x000800FE` | `0x00080103` | 1 | 0 | 1 | HIGH |
| 5 | `EncDragonPriest` | NPC_ | `0x00023A93` | CrDragonPriestVoice | MG07 | _(no EDID)_ | `0x000800F9` | `0x00080104` | 1 | 0 | 1 | HIGH |
| 6 | `EncDragonPriest` | NPC_ | `0x00023A93` | CrDragonPriestVoice | MG07 | _(no EDID)_ | `0x000800FC` | `0x00080105` | 1 | 0 | 1 | HIGH |
| 7 | `EncDragonPriest` | NPC_ | `0x00023A93` | CrDragonPriestVoice | MG07 | _(no EDID)_ | `0x000800FD` | `0x00080106` | 1 | 0 | 1 | HIGH |
| 8 | `EncDragonPriest` | NPC_ | `0x00023A93` | CrDragonPriestVoice | MG07 | _(no EDID)_ | `0x000800F8` | `0x00080107` | 1 | 0 | 1 | HIGH |
| 9 | `EncDragonPriest` | NPC_ | `0x00023A93` | CrDragonPriestVoice | MG07 | _(no EDID)_ | `0x000800F6` | `0x00080109` | 1 | 0 | 1 | HIGH |
| 10 | `EncDragonPriest` | NPC_ | `0x00023A93` | CrDragonPriestVoice | MG07 | _(no EDID)_ | `0x000800FB` | `0x0008010A` | 1 | 0 | 1 | HIGH |
| 11 | `EncDragonPriest` | NPC_ | `0x00023A93` | CrDragonPriestVoice | MG07 | _(no EDID)_ | `0x000800FF` | `0x0008010B` | 1 | 0 | 1 | HIGH |
| 12 | `MQ304Alduin` | NPC_ | `0x0004E9BC` | CrUniqueAlduin | MQ305 | _(no EDID)_ | `0x000ED356` | `0x000ED359` | 1 | 0 | 1 | HIGH |
| 13 | `MS14Helgi` | NPC_ | `0x000274A5` | FemaleChild | MS14 | _(no EDID)_ | `0x0003664E` | `0x0003664F` | 1 | 0 | 1 | HIGH |
| 14 | `MS06Potema` | NPC_ | `0x00026C52` | FemaleCommander | MS06Start | _(no EDID)_ | `0x0009D9C3` | `0x0009D9D7` | 1 | 0 | 1 | MEDIUM |
| 15 | `MS06Potema` | NPC_ | `0x00026C52` | FemaleCommander | MS06Start | _(no EDID)_ | `0x0009D9C7` | `0x0009D9D9` | 1 | 0 | 1 | MEDIUM |
| 16 | `MS06Potema` | NPC_ | `0x00026C52` | FemaleCommander | MS06Start | _(no EDID)_ | `0x0009D9D0` | `0x0009D9E4` | 1 | 0 | 1 | MEDIUM |
| 17 | `dunAnsilvundLuahAlSkaven` | NPC_ | `0x0002333A` | FemaleCondescending | dunAnsilvundQST | _(no EDID)_ | `0x00093BBB` | `0x00093BC0` | 1 | 0 | 1 | HIGH |
| 18 | `dunAnsilvundLuahAlSkaven` | NPC_ | `0x0002333A` | FemaleCondescending | dunAnsilvundQST | _(no EDID)_ | `0x00093BBD` | `0x00093BC8` | 1 | 0 | 1 | HIGH |
| 19 | `dunAnsilvundLuahAlSkaven` | NPC_ | `0x0002333A` | FemaleCondescending | dunAnsilvundQST | _(no EDID)_ | `0x00093BBC` | `0x00093BCB` | 1 | 0 | 1 | HIGH |
| 20 | `dunAnsilvundLuahAlSkaven` | NPC_ | `0x0002333A` | FemaleCondescending | dunAnsilvundQST | _(no EDID)_ | `0x000B6469` | `0x000B646A` | 1 | 0 | 1 | HIGH |
| 21 | `Eola` | NPC_ | `0x0001990F` | FemaleSultry | DA11HallScene | _(no EDID)_ | `0x0007D92C` | `0x0007D935` | 1 | 0 | 1 | HIGH |
| 22 | `Eola` | NPC_ | `0x0001990F` | FemaleSultry | DA11HallScene | _(no EDID)_ | `0x0007D92E` | `0x0007D93F` | 1 | 0 | 1 | HIGH |
| 23 | `Eola` | NPC_ | `0x0001990F` | FemaleSultry | DA11HallScene | _(no EDID)_ | `0x00099CF2` | `0x00099CF8` | 1 | 0 | 1 | HIGH |
| 24 | `DA02Boethiah` | NPC_ | `0x0004D91B` | FemaleUniqueBoethiah | DA02 | _(no EDID)_ | `0x0004D88C` | `0x0004D8C8` | 1 | 0 | 1 | HIGH |
| 25 | `DA02Boethiah` | NPC_ | `0x0004D91B` | FemaleUniqueBoethiah | DA02 | _(no EDID)_ | `0x00081178` | `0x00081179` | 1 | 0 | 1 | HIGH |
...
```text
# DA01AzuraVoice (FemaleUniqueAzura) - DA01 / _(no EDID)_ [MEDIUM]
...
# Nelacar (MaleElfHaughty) - DA01 / _(no EDID)_ [LOW]
...
# EncDragonPriest (CrDragonPriestVoice) - MG07 / _(no EDID)_ [HIGH]
...
# MQ304Alduin (CrUniqueAlduin) - MQ305 / _(no EDID)_ [HIGH]
...
# MS14Helgi (FemaleChild) - MS14 / _(no EDID)_ [HIGH]
...
# MS06Potema (FemaleCommander) - MS06Start / _(no EDID)_ [MEDIUM]
...
# dunAnsilvundLuahAlSkaven (FemaleCondescending) - dunAnsilvundQST / _(no EDID)_ [HIGH]
...
# Eola (FemaleSultry) - DA11HallScene / _(no EDID)_ [HIGH]
...
# DA02Boethiah (FemaleUniqueBoethiah) - DA02 / _(no EDID)_ [HIGH]
...
say 00081178
# INFO 0x00081179 | FUZ sound\voice\skyrim.esm\femaleuniqueboethiah\da02__00081179_1.fuz | matching BSAs: Skyrim - Voices_en0.bsa, Skyrim - Voices_es0.bsa
