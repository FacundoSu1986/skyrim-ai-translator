...
async def test_generate_voice_file_two_responses_same_info_distinct_files(tmp_path):
    ...
    out_dir = tmp_path / "Sound"
    responses = [
        StringEntry(form_id="00000333", text="First", translated_text="Primera", is_dialog=True,
                    voice_type="MaleGuard", string_index=0),
        StringEntry(form_id="00000333", text="Second", translated_text="Segunda", is_dialog=True,
                    voice_type="MaleGuard", string_index=4),
    ]
...
async def test_generate_voice_file_without_index_keeps_plain_name(tmp_path):
    ...
    out_dir = tmp_path / "Sound"
    entry = StringEntry(form_id="00000999", text="Hi", translated_text="Hola", is_dialog=True,
                        voice_type="MaleGuard", string_index=None)
